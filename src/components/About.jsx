  ...
  return (
    ...
    <section id="about" className="bg-white py-24 border-t border-gray-900">
        ...
        <div className="text-center py-5"> {/* Adjusted padding for alignment */}
          ...
          <p className="text-lg text-shadow-md font-serif text-black leading-relaxed mb-3 text-justify">
          ...
          <p className="text-lg text-shadow-md font-serif text-black leading-relaxed text-justify">
